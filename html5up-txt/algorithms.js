...
function getAlgorithms(complexity, set) {
    ...
    returnAlgorithms += "<tr><th><p class='alg algHeader'>Name</p></th><th><p class='alg algHeader'>Image</p></th>"+
    "<th><p class='alg algHeader'>Notation</p></th><th><p class='alg algHeader'>Sub Class</p></th></tr>"; // header for algorithm tables // <th><p class='alg'>Note</p></th>
...
function learnAlgorithms(algorithmID) {
    ...
    if (learnedAlg.style.background != "") {
        learnedAlg.style.background = "";
    } else {
        learnedAlg.style.background = "#B1DDAB";
    }
}
